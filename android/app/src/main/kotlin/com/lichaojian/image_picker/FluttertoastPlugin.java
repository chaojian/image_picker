...
public class FluttertoastPlugin implements MethodCallHandler {
    ...
    public static void registerWith(FlutterView flutterView) {
        final MethodChannel channel = new MethodChannel(flutterView, "PonnamKarthik/fluttertoast");
        channel.setMethodCallHandler(new FluttertoastPlugin(flutterView.getContext()));
    }
